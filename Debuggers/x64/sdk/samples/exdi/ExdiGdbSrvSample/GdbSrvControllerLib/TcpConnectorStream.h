...
namespace GdbSrvControllerLib
{
    ...
    class TcpIpStream final
    {
       public:
        ...
        int Send(_In_ LPCSTR pBuffer, _In_ int length)
        {
            ...
            CallDisplayFunction(pBuffer, GdbSrvTextType::Command);
        ...
        int Receive(_Out_writes_bytes_(length) PCHAR pBuffer, _In_ int length)
        {
            ...
            CallDisplayFunction(pBuffer, GdbSrvTextType::CommandOutput);
        ...
        inline void CallDisplayFunction(_In_ LPCSTR pBuffer, _In_ GdbSrvTextType textType)
        {
            ...
            {
                m_pDisplayFunction(pBuffer, strlen(pBuffer), textType, m_pTextHandler, m_channel);
            }
        }
    ...
    class TcpConnectorStream final
    {
      public:
        ...
        TcpIpStream * GetLinkLayerStreamEntry(size_t coreNumber) const {return m_pTLinkLayerStreamClass[coreNumber].get();}
