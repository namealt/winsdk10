...
__analysis_noreturn 
void __stdcall
        _com_raise_error(_In_ HRESULT hr, _In_opt_ IErrorInfo* perrinfo = 0) throw(_com_error);

#ifndef _INC_COMUTIL
__analysis_noreturn 
void __stdcall
        _com_issue_error(_In_ HRESULT) throw(_com_error);
#endif

__analysis_noreturn 
void __stdcall
        _com_issue_errorex(_In_ HRESULT, _In_ IUnknown*, _In_ REFIID) throw(_com_error);

HRESULT __stdcall
        _com_dispatch_propget(_In_ IDispatch*, _In_ DISPID, _In_ VARTYPE, _Out_ void*) throw(_com_error);
HRESULT __cdecl
        _com_dispatch_propput(_In_ IDispatch*, _In_ DISPID, _In_ VARTYPE, ...) throw(_com_error);

HRESULT __cdecl
_com_dispatch_method(_In_ IDispatch* pDispatch,
                     _In_ DISPID dwDispID,
                     _In_ WORD wFlags,
                     _In_ VARTYPE vtRet,
                     _When_(vtRet == VT_EMPTY, _Reserved_)
                     _When_(vtRet != VT_EMPTY, _Out_)  void* pvRet,
                     _In_opt_z_ _Literal_ const wchar_t* pwParamInfo,
                     ...) throw(_com_error);

HRESULT __stdcall
        _com_dispatch_raw_propget(_In_ IDispatch*, _In_ DISPID, _In_ VARTYPE, _Out_ void*) throw();
HRESULT __cdecl
        _com_dispatch_raw_propput(_In_ IDispatch*, _In_ DISPID, _In_ VARTYPE, ...) throw();

HRESULT __cdecl
_com_dispatch_raw_method(_In_ IDispatch* pDispatch,
                         _In_ DISPID dwDispID,
                         _In_ WORD wFlags,
                         _In_ VARTYPE vtRet,
                         _When_(vtRet == VT_EMPTY, _Reserved_)
...
public:
        // Constructors
        //
        __drv_preferredFunction("_com_error as defined in ComUtil.h", "This file (comdef.h) is scheduled for deprecation.")
        _com_error(_In_ HRESULT hr,
               _In_opt_ IErrorInfo* perrinfo = NULL,
               _In_opt_ bool fAddRef = false) throw();
        __drv_preferredFunction("_com_error as defined in ComUtil.h", "This file (comdef.h) is scheduled for deprecation.")
        _com_error(_In_ const _com_error& that) throw();
        ...
        // Assignment operator
        //
        _com_error& operator=(_In_ const _com_error& that) throw();
        ...
        static HRESULT WCodeToHRESULT(_In_ WORD wCode) throw();
        static WORD HRESULTToWCode(_In_ HRESULT hr) throw();
...
__drv_preferredFunction("_com_error as defined in ComUtil.h", "This file (comdef.h) is scheduled for deprecation.")
inline _com_error::_com_error(_In_ HRESULT hr,
                              _In_opt_ IErrorInfo* perrinfo,
                              _In_opt_ bool fAddRef) throw()
...
__drv_preferredFunction("_com_error as defined in ComUtil.h", "This file (comdef.h) is scheduled for deprecation.")
inline _com_error::_com_error(_In_ const _com_error& that) throw()
...
inline _com_error& _com_error::operator=(_In_ const _com_error& that) throw()
{
        if (this != &that) {
...
inline HRESULT _com_error::WCodeToHRESULT(_In_ WORD wCode) throw()
{
        return wCode >= 0xFE00 ? WCODE_HRESULT_LAST : WCODE_HRESULT_FIRST + wCode;
}

inline WORD _com_error::HRESULTToWCode(_In_ HRESULT hr) throw()
{
