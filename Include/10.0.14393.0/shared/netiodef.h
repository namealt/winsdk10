...
//
// Accept fastopen cookies between 4 and 16 bytes generated by a remote
// server, but always generate cookies of size 8 bytes. For a cookie request,
// the option always contains zero bytes for the cookie.
//
#define TCP_FASTOPEN_COOKIE_SIZE 8
#define TCP_FASTOPEN_COOKIE_SIZE_MIN 4
#define TCP_FASTOPEN_COOKIE_SIZE_MAX 16

typedef struct _TCP_FASTOPEN_COOKIE {
    UINT8 Length;
    UINT8 Value[TCP_FASTOPEN_COOKIE_SIZE_MAX];
} TCP_FASTOPEN_COOKIE, *PTCP_FASTOPEN_COOKIE;
