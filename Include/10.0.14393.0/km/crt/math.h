...
// Not touching _CRTIMP here for backwards compatibility and instead just suppressing this instance of the warning
#pragma warning(suppress:4091) // 'extern __declspec(dllimport)': ignored on left of 'double' when no variable is declared
