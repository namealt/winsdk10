...
** __MACHINEARM_64    : ARM and 64-bit Arch(x64 and ARM64) only
...
#define __MACHINEARM_64    __MACHINE
...
__MACHINEARM_ARM64(__int64 _InterlockedAdd64_acq(_Interlocked_operand_ __int64 volatile * _Addend, __int64 _Value))
__MACHINEARM_ARM64(__int64 _InterlockedAdd64_nf(_Interlocked_operand_ __int64 volatile * _Addend, __int64 _Value))
__MACHINEARM_ARM64(__int64 _InterlockedAdd64_rel(_Interlocked_operand_ __int64 volatile * _Addend, __int64 _Value))
__MACHINEX86(long _InterlockedAddLargeStatistic(_Interlocked_operand_ __int64 volatile * _Addend, long _Value))
__MACHINEARM_ARM64(long _InterlockedAdd(_Interlocked_operand_ long volatile * _Addend, long _Value))
__MACHINEARM_ARM64(long _InterlockedAdd_acq(_Interlocked_operand_ long volatile * _Addend, long _Value))
__MACHINEARM_ARM64(long _InterlockedAdd_nf(_Interlocked_operand_ long volatile * _Addend, long _Value))
__MACHINEARM_ARM64(long _InterlockedAdd_rel(_Interlocked_operand_ long volatile * _Addend, long _Value))
__MACHINE(long _InterlockedAnd(_Interlocked_operand_ long volatile * _Value, long _Mask))
__MACHINE(short _InterlockedAnd16(_Interlocked_operand_ short volatile * _Value, short _Mask))
__MACHINEARM_ARM64(short _InterlockedAnd16_acq(_Interlocked_operand_ short volatile * _Value, short _Mask))
__MACHINEARM_ARM64(short _InterlockedAnd16_nf(_Interlocked_operand_ short volatile * _Value, short _Mask))
__MACHINEX64(short _InterlockedAnd16_np(_Interlocked_operand_ short volatile * _Value, short _Mask))
__MACHINEARM_ARM64(short _InterlockedAnd16_rel(_Interlocked_operand_ short volatile * _Value, short _Mask))
__MACHINEARM_64(__int64 _InterlockedAnd64(_Interlocked_operand_ __int64 volatile * _Value, __int64 _Mask))
__MACHINEARM_ARM64(__int64 _InterlockedAnd64_acq(_Interlocked_operand_ __int64 volatile * _Value, __int64 _Mask))
__MACHINEARM_ARM64(__int64 _InterlockedAnd64_nf(_Interlocked_operand_ __int64 volatile * _Value, __int64 _Mask))
__MACHINEX64(__int64 _InterlockedAnd64_np(_Interlocked_operand_ __int64 volatile * _Value, __int64 _Mask))
__MACHINEARM_ARM64(__int64 _InterlockedAnd64_rel(_Interlocked_operand_ __int64 volatile * _Value, __int64 _Mask))
__MACHINE(char _InterlockedAnd8(_Interlocked_operand_ char volatile * _Value, char _Mask))
__MACHINEARM_ARM64(char _InterlockedAnd8_acq(_Interlocked_operand_ char volatile * _Value, char _Mask))
__MACHINEARM_ARM64(char _InterlockedAnd8_nf(_Interlocked_operand_ char volatile * _Value, char _Mask))
__MACHINEX64(char _InterlockedAnd8_np(_Interlocked_operand_ char volatile * _Value, char _Mask))
__MACHINEARM_ARM64(char _InterlockedAnd8_rel(_Interlocked_operand_ char volatile * _Value, char _Mask))
__MACHINEARM_ARM64(long _InterlockedAnd_acq(_Interlocked_operand_ long volatile * _Value, long _Mask))
__MACHINEARM_ARM64(long _InterlockedAnd_nf(_Interlocked_operand_ long volatile * _Value, long _Mask))
__MACHINEX64(long _InterlockedAnd_np(_Interlocked_operand_ long volatile * _Value, long _Mask))
__MACHINEARM_ARM64(long _InterlockedAnd_rel(_Interlocked_operand_ long volatile * _Value, long _Mask))
__MACHINE(long __cdecl _InterlockedCompareExchange(_Interlocked_operand_ long volatile * _Destination, long _Exchange, long _Comparand))
__MACHINEWVMPURE(long _InterlockedCompareExchange(_Interlocked_operand_ long volatile * _Destination, long _Exchange, long _Comparand))
__MACHINEARM64_X64(unsigned char _InterlockedCompareExchange128(_Interlocked_operand_ __int64 volatile * _Destination, __int64 _ExchangeHigh, __int64 _ExchangeLow, __int64 * _ComparandResult))
__MACHINEARM64(unsigned char _InterlockedCompareExchange128_acq(_Interlocked_operand_ __int64 volatile * _Destination, __int64 _ExchangeHigh, __int64 _ExchangeLow, __int64 * _ComparandResult))
__MACHINEARM64(unsigned char _InterlockedCompareExchange128_nf(_Interlocked_operand_ __int64 volatile * _Destination, __int64 _ExchangeHigh, __int64 _ExchangeLow, __int64 * _ComparandResult))
__MACHINEX64(unsigned char _InterlockedCompareExchange128_np(_Interlocked_operand_ __int64 volatile * _Destination, __int64 _ExchangeHigh, __int64 _ExchangeLow, __int64 * _ComparandResult))
__MACHINEARM64(unsigned char _InterlockedCompareExchange128_rel(_Interlocked_operand_ __int64 volatile * _Destination, __int64 _ExchangeHigh, __int64 _ExchangeLow, __int64 * _ComparandResult))
__MACHINE(short _InterlockedCompareExchange16(_Interlocked_operand_ short volatile * _Destination, short _Exchange, short _Comparand))
__MACHINEARM_ARM64(short _InterlockedCompareExchange16_acq(_Interlocked_operand_ short volatile * _Destination, short _Exchange, short _Comparand))
__MACHINEARM_ARM64(short _InterlockedCompareExchange16_nf(_Interlocked_operand_ short volatile * _Destination, short _Exchange, short _Comparand))
__MACHINEX64(short _InterlockedCompareExchange16_np(_Interlocked_operand_ short volatile * _Destination, short _Exchange, short _Comparand))
__MACHINEARM_ARM64(short _InterlockedCompareExchange16_rel(_Interlocked_operand_ short volatile * _Destination, short _Exchange, short _Comparand))
__MACHINE(__int64 _InterlockedCompareExchange64(_Interlocked_operand_ __int64 volatile * _Destination, __int64 _Exchange, __int64 _Comparand))
__MACHINEARM_ARM64(__int64 _InterlockedCompareExchange64_acq(_Interlocked_operand_ __int64 volatile * _Destination, __int64 _Exchange, __int64 _Comparand))
__MACHINEARM_ARM64(__int64 _InterlockedCompareExchange64_nf(_Interlocked_operand_ __int64 volatile * _Destination, __int64 _Exchange, __int64 _Comparand))
__MACHINEX64(__int64 _InterlockedCompareExchange64_np(_Interlocked_operand_ __int64 volatile * _Destination, __int64 _Exchange, __int64 _Comparand))
__MACHINEARM_ARM64(__int64 _InterlockedCompareExchange64_rel(_Interlocked_operand_ __int64 volatile * _Destination, __int64 _Exchange, __int64 _Comparand))
__MACHINE(char _InterlockedCompareExchange8(_Interlocked_operand_ char volatile * _Destination, char _Exchange, char _Comparand))
__MACHINEARM_ARM64(char _InterlockedCompareExchange8_acq(_Interlocked_operand_ char volatile * _Destination, char _Exchange, char _Comparand))
__MACHINEARM_ARM64(char _InterlockedCompareExchange8_nf(_Interlocked_operand_ char volatile * _Destination, char _Exchange, char _Comparand))
__MACHINEARM_ARM64(char _InterlockedCompareExchange8_rel(_Interlocked_operand_ char volatile * _Destination, char _Exchange, char _Comparand))
__MACHINE(void * _InterlockedCompareExchangePointer(_Interlocked_operand_ void * volatile * _Destination, void * _Exchange, void * _Comparand))
__MACHINEARM_ARM64(void * _InterlockedCompareExchangePointer_acq(_Interlocked_operand_ void * volatile * _Destination, void * _Exchange, void * _Comparand))
__MACHINEARM_ARM64(void * _InterlockedCompareExchangePointer_nf(_Interlocked_operand_ void * volatile * _Destination, void * _Exchange, void * _Comparand))
__MACHINEX64(void * _InterlockedCompareExchangePointer_np(_Interlocked_operand_ void * volatile * _Destination, void * _Exchange, void * _Comparand))
__MACHINEARM_ARM64(void * _InterlockedCompareExchangePointer_rel(_Interlocked_operand_ void * volatile * _Destination, void * _Exchange, void * _Comparand))
__MACHINEARM_ARM64(long _InterlockedCompareExchange_acq(_Interlocked_operand_ long volatile * _Destination, long _Exchange, long _Comparand))
__MACHINEARM_ARM64(long _InterlockedCompareExchange_nf(_Interlocked_operand_ long volatile * _Destination, long _Exchange, long _Comparand))
__MACHINEX64(long _InterlockedCompareExchange_np(_Interlocked_operand_ long volatile * _Destination, long _Exchange, long _Comparand))
__MACHINEARM_ARM64(long _InterlockedCompareExchange_rel(_Interlocked_operand_ long volatile * _Destination, long _Exchange, long _Comparand))
__MACHINE(long __cdecl _InterlockedDecrement(_Interlocked_operand_ long volatile * _Addend))
__MACHINEWVMPURE(long _InterlockedDecrement(_Interlocked_operand_ long volatile * _Addend))
__MACHINE(short _InterlockedDecrement16(_Interlocked_operand_ short volatile * _Addend))
__MACHINEARM_ARM64(short _InterlockedDecrement16_acq(_Interlocked_operand_ short volatile * _Addend))
__MACHINEARM_ARM64(short _InterlockedDecrement16_nf(_Interlocked_operand_ short volatile * _Addend))
__MACHINEARM_ARM64(short _InterlockedDecrement16_rel(_Interlocked_operand_ short volatile * _Addend))
__MACHINEARM_64(__int64 _InterlockedDecrement64(_Interlocked_operand_ __int64 volatile * _Addend))
__MACHINEARM_ARM64(__int64 _InterlockedDecrement64_acq(_Interlocked_operand_ __int64 volatile * _Addend))
__MACHINEARM_ARM64(__int64 _InterlockedDecrement64_nf(_Interlocked_operand_ __int64 volatile * _Addend))
__MACHINEARM_ARM64(__int64 _InterlockedDecrement64_rel(_Interlocked_operand_ __int64 volatile * _Addend))
__MACHINEARM_ARM64(long _InterlockedDecrement_acq(_Interlocked_operand_ long volatile * _Addend))
__MACHINEARM_ARM64(long _InterlockedDecrement_nf(_Interlocked_operand_ long volatile * _Addend))
__MACHINEARM_ARM64(long _InterlockedDecrement_rel(_Interlocked_operand_ long volatile * _Addend))
__MACHINE(long __cdecl _InterlockedExchange(_Interlocked_operand_ long volatile * _Target, long _Value))
__MACHINE(short _InterlockedExchange16(_Interlocked_operand_ short volatile * _Target, short _Value))
__MACHINEARM_ARM64(short _InterlockedExchange16_acq(_Interlocked_operand_ short volatile * _Target, short _Value))
__MACHINEARM_ARM64(short _InterlockedExchange16_nf(_Interlocked_operand_ short volatile * _Target, short _Value))
__MACHINEARM_64(__int64 _InterlockedExchange64(_Interlocked_operand_ __int64 volatile * _Target, __int64 _Value))
__MACHINEARM_ARM64(__int64 _InterlockedExchange64_acq(_Interlocked_operand_ __int64 volatile * _Target, __int64 _Value))
__MACHINEARM_ARM64(__int64 _InterlockedExchange64_nf(_Interlocked_operand_ __int64 volatile * _Target, __int64 _Value))
...
__MACHINE(long __cdecl _InterlockedExchangeAdd(_Interlocked_operand_ long volatile * _Addend, long _Value))
__MACHINE(short _InterlockedExchangeAdd16(_Interlocked_operand_ short volatile * _Addend, short _Value))
__MACHINEARM_ARM64(short _InterlockedExchangeAdd16_acq(_Interlocked_operand_ short volatile * _Addend, short _Value))
__MACHINEARM_ARM64(short _InterlockedExchangeAdd16_nf(_Interlocked_operand_ short volatile * _Addend, short _Value))
__MACHINEARM_ARM64(short _InterlockedExchangeAdd16_rel(_Interlocked_operand_ short volatile * _Addend, short _Value))
__MACHINEARM_64(__int64 _InterlockedExchangeAdd64(_Interlocked_operand_ __int64 volatile * _Addend, __int64 _Value))
__MACHINEARM_ARM64(__int64 _InterlockedExchangeAdd64_acq(_Interlocked_operand_ __int64 volatile * _Addend, __int64 _Value))
__MACHINEARM_ARM64(__int64 _InterlockedExchangeAdd64_nf(_Interlocked_operand_ __int64 volatile * _Addend, __int64 _Value))
__MACHINEARM_ARM64(__int64 _InterlockedExchangeAdd64_rel(_Interlocked_operand_ __int64 volatile * _Addend, __int64 _Value))
__MACHINE(char _InterlockedExchangeAdd8(_Interlocked_operand_ char volatile * _Addend, char _Value))
__MACHINEARM_ARM64(char _InterlockedExchangeAdd8_acq(_Interlocked_operand_ char volatile * _Addend, char _Value))
__MACHINEARM_ARM64(char _InterlockedExchangeAdd8_nf(_Interlocked_operand_ char volatile * _Addend, char _Value))
__MACHINEARM_ARM64(char _InterlockedExchangeAdd8_rel(_Interlocked_operand_ char volatile * _Addend, char _Value))
__MACHINEARM_ARM64(long _InterlockedExchangeAdd_acq(_Interlocked_operand_ long volatile * _Addend, long _Value))
__MACHINEARM_ARM64(long _InterlockedExchangeAdd_nf(_Interlocked_operand_ long volatile * _Addend, long _Value))
__MACHINEARM_ARM64(long _InterlockedExchangeAdd_rel(_Interlocked_operand_ long volatile * _Addend, long _Value))
__MACHINE(void * _InterlockedExchangePointer(_Interlocked_operand_ void * volatile * _Target, void * _Value))
__MACHINEARM_ARM64(void * _InterlockedExchangePointer_acq(_Interlocked_operand_ void * volatile * _Target, void * _Value))
__MACHINEARM_ARM64(void * _InterlockedExchangePointer_nf(_Interlocked_operand_ void * volatile * _Target, void * _Value))
__MACHINEARM_ARM64(long _InterlockedExchange_acq(_Interlocked_operand_ long volatile * _Target, long _Value))
__MACHINEARM_ARM64(long _InterlockedExchange_nf(_Interlocked_operand_ long volatile * _Target, long _Value))
__MACHINE(long __cdecl  _InterlockedIncrement(_Interlocked_operand_ long volatile * _Addend))
__MACHINEWVMPURE(long _InterlockedIncrement(_Interlocked_operand_ long volatile * _Addend))
__MACHINE(short _InterlockedIncrement16(_Interlocked_operand_ short volatile * _Addend))
__MACHINEARM_ARM64(short _InterlockedIncrement16_acq(_Interlocked_operand_ short volatile * _Addend))
__MACHINEARM_ARM64(short _InterlockedIncrement16_nf(_Interlocked_operand_ short volatile * _Addend))
__MACHINEARM_ARM64(short _InterlockedIncrement16_rel(_Interlocked_operand_ short volatile * _Addend))
__MACHINEARM_64(__int64 _InterlockedIncrement64(_Interlocked_operand_ __int64 volatile * _Addend))
__MACHINEARM_ARM64(__int64 _InterlockedIncrement64_acq(_Interlocked_operand_ __int64 volatile * _Addend))
__MACHINEARM_ARM64(__int64 _InterlockedIncrement64_nf(_Interlocked_operand_ __int64 volatile * _Addend))
__MACHINEARM_ARM64(__int64 _InterlockedIncrement64_rel(_Interlocked_operand_ __int64 volatile * _Addend))
__MACHINEARM_ARM64(long _InterlockedIncrement_acq(_Interlocked_operand_ long volatile * _Addend))
__MACHINEARM_ARM64(long _InterlockedIncrement_nf(_Interlocked_operand_ long volatile * _Addend))
__MACHINEARM_ARM64(long _InterlockedIncrement_rel(_Interlocked_operand_ long volatile * _Addend))
__MACHINE(long _InterlockedOr(_Interlocked_operand_ long volatile * _Value, long _Mask))
__MACHINE(short _InterlockedOr16(_Interlocked_operand_ short volatile * _Value, short _Mask))
__MACHINEARM_ARM64(short _InterlockedOr16_acq(_Interlocked_operand_ short volatile * _Value, short _Mask))
__MACHINEARM_ARM64(short _InterlockedOr16_nf(_Interlocked_operand_ short volatile * _Value, short _Mask))
__MACHINEX64(short _InterlockedOr16_np(_Interlocked_operand_ short volatile * _Value, short _Mask))
__MACHINEARM_ARM64(short _InterlockedOr16_rel(_Interlocked_operand_ short volatile * _Value, short _Mask))
__MACHINEARM_64(__int64 _InterlockedOr64(_Interlocked_operand_ __int64 volatile * _Value, __int64 _Mask))
__MACHINEARM_ARM64(__int64 _InterlockedOr64_acq(_Interlocked_operand_ __int64 volatile * _Value, __int64 _Mask))
__MACHINEARM_ARM64(__int64 _InterlockedOr64_nf(_Interlocked_operand_ __int64 volatile * _Value, __int64 _Mask))
__MACHINEX64(__int64 _InterlockedOr64_np(_Interlocked_operand_ __int64 volatile * _Value, __int64 _Mask))
__MACHINEARM_ARM64(__int64 _InterlockedOr64_rel(_Interlocked_operand_ __int64 volatile * _Value, __int64 _Mask))
__MACHINE(char _InterlockedOr8(_Interlocked_operand_ char volatile * _Value, char _Mask))
__MACHINEARM_ARM64(char _InterlockedOr8_acq(_Interlocked_operand_ char volatile * _Value, char _Mask))
__MACHINEARM_ARM64(char _InterlockedOr8_nf(_Interlocked_operand_ char volatile * _Value, char _Mask))
__MACHINEX64(char _InterlockedOr8_np(_Interlocked_operand_ char volatile * _Value, char _Mask))
__MACHINEARM_ARM64(char _InterlockedOr8_rel(_Interlocked_operand_ char volatile * _Value, char _Mask))
__MACHINEARM_ARM64(long _InterlockedOr_acq(_Interlocked_operand_ long volatile * _Value, long _Mask))
__MACHINEARM_ARM64(long _InterlockedOr_nf(_Interlocked_operand_ long volatile * _Value, long _Mask))
__MACHINEX64(long _InterlockedOr_np(_Interlocked_operand_ long volatile * _Value, long _Mask))
__MACHINEARM_ARM64(long _InterlockedOr_rel(_Interlocked_operand_ long volatile * _Value, long _Mask))
__MACHINE(long _InterlockedXor(_Interlocked_operand_ long volatile * _Value, long _Mask))
__MACHINE(short _InterlockedXor16(_Interlocked_operand_ short volatile * _Value, short _Mask))
__MACHINEARM_ARM64(short _InterlockedXor16_acq(_Interlocked_operand_ short volatile * _Value, short _Mask))
__MACHINEARM_ARM64(short _InterlockedXor16_nf(_Interlocked_operand_ short volatile * _Value, short _Mask))
__MACHINEX64(short _InterlockedXor16_np(_Interlocked_operand_ short volatile * _Value, short _Mask))
__MACHINEARM_ARM64(short _InterlockedXor16_rel(_Interlocked_operand_ short volatile * _Value, short _Mask))
__MACHINEARM_64(__int64 _InterlockedXor64(_Interlocked_operand_ __int64 volatile * _Value, __int64 _Mask))
__MACHINEARM_ARM64(__int64 _InterlockedXor64_acq(_Interlocked_operand_ __int64 volatile * _Value, __int64 _Mask))
__MACHINEARM_ARM64(__int64 _InterlockedXor64_nf(_Interlocked_operand_ __int64 volatile * _Value, __int64 _Mask))
__MACHINEX64(__int64 _InterlockedXor64_np(_Interlocked_operand_ __int64 volatile * _Value, __int64 _Mask))
__MACHINEARM_ARM64(__int64 _InterlockedXor64_rel(_Interlocked_operand_ __int64 volatile * _Value, __int64 _Mask))
__MACHINE(char _InterlockedXor8(_Interlocked_operand_ char volatile * _Value, char _Mask))
__MACHINEARM_ARM64(char _InterlockedXor8_acq(_Interlocked_operand_ char volatile * _Value, char _Mask))
__MACHINEARM_ARM64(char _InterlockedXor8_nf(_Interlocked_operand_ char volatile * _Value, char _Mask))
__MACHINEX64(char _InterlockedXor8_np(_Interlocked_operand_ char volatile * _Value, char _Mask))
__MACHINEARM_ARM64(char _InterlockedXor8_rel(_Interlocked_operand_ char volatile * _Value, char _Mask))
__MACHINEARM_ARM64(long _InterlockedXor_acq(_Interlocked_operand_ long volatile * _Value, long _Mask))
__MACHINEARM_ARM64(long _InterlockedXor_nf(_Interlocked_operand_ long volatile * _Value, long _Mask))
__MACHINEX64(long _InterlockedXor_np(_Interlocked_operand_ long volatile * _Value, long _Mask))
__MACHINEARM_ARM64(long _InterlockedXor_rel(_Interlocked_operand_ long volatile * _Value, long _Mask))
...
__MACHINE(__declspec(noreturn) void __fastfail(_In_ unsigned int))
...
__MACHINEARM64(unsigned int __svc(unsigned int, ...))
...
__MACHINE(unsigned char _interlockedbittestandreset(_Interlocked_operand_ long volatile *, long))
__MACHINEARM64_X64(unsigned char _interlockedbittestandreset64(_Interlocked_operand_ __int64 volatile *, __int64))
__MACHINEARM_ARM64(unsigned char _interlockedbittestandreset_acq(_Interlocked_operand_ long volatile *, long))
__MACHINEARM_ARM64(unsigned char _interlockedbittestandreset_nf(_Interlocked_operand_ long volatile *, long))
__MACHINEARM_ARM64(unsigned char _interlockedbittestandreset_rel(_Interlocked_operand_ long volatile *, long))
__MACHINEARM64(unsigned char _interlockedbittestandreset64_acq(_Interlocked_operand_ __int64 volatile *, __int64))
__MACHINEARM64(unsigned char _interlockedbittestandreset64_rel(_Interlocked_operand_ __int64 volatile *, __int64))
__MACHINEARM64(unsigned char _interlockedbittestandreset64_nf(_Interlocked_operand_ __int64 volatile *, __int64))
__MACHINE(unsigned char _interlockedbittestandset(_Interlocked_operand_ long volatile *, long))
__MACHINEARM64_X64(unsigned char _interlockedbittestandset64(_Interlocked_operand_ __int64 volatile *, __int64))
__MACHINEARM_ARM64(unsigned char _interlockedbittestandset_acq(_Interlocked_operand_ long volatile *, long))
__MACHINEARM_ARM64(unsigned char _interlockedbittestandset_nf(_Interlocked_operand_ long volatile *, long))
__MACHINEARM_ARM64(unsigned char _interlockedbittestandset_rel(_Interlocked_operand_ long volatile *, long))
__MACHINEARM64(unsigned char _interlockedbittestandset64_acq(_Interlocked_operand_ __int64 volatile *, __int64))
__MACHINEARM64(unsigned char _interlockedbittestandset64_rel(_Interlocked_operand_ __int64 volatile *, __int64))
__MACHINEARM64(unsigned char _interlockedbittestandset64_nf(_Interlocked_operand_ __int64 volatile *, __int64))
...
__MACHINEX86_X64(void _mm_prefetch(_In_ char const *, _In_ int))
...
__MACHINE(unsigned short _rotl16(unsigned short _Value, unsigned char _Shift))
__MACHINE(unsigned __int64 __cdecl _rotl64(_In_ unsigned __int64 _Value, _In_ int _Shift))
__MACHINE(unsigned char _rotl8(unsigned char _Value, unsigned char _Shift))
__MACHINE(unsigned int __cdecl _rotr(_In_ unsigned int _Value, _In_ int _Shift))
__MACHINE(unsigned short _rotr16(unsigned short _Value, unsigned char _Shift))
__MACHINE(unsigned __int64 __cdecl _rotr64(_In_ unsigned __int64 _Value, _In_ int _Shift))
__MACHINE(unsigned char _rotr8(unsigned char _Value, unsigned char _Shift))
