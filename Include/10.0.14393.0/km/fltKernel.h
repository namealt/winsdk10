...
//
//  This defines items that only exist in Windows RedStone 1 or later
//
...
FltAllocateExtraCreateParameter (
    ...
    _In_ ULONG PoolTag,
    _Outptr_result_buffer_(SizeOfContext) PVOID *EcpContext
    );
...
FltRemoveExtraCreateParameter (
    ...
    _Inout_ PECP_LIST EcpList,
    _In_ LPCGUID EcpType,
    _Outptr_result_buffer_(*EcpContextSize) PVOID *EcpContext,
    _Out_opt_ ULONG *EcpContextSize
    );
...
///////////////////////////////////////////////////////////////////////////////
//
//  Routines for getting IO attribution handle and propagate IRP extensions
//
///////////////////////////////////////////////////////////////////////////////

#if FLT_MGR_WIN10_RS1
