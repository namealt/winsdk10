...
#define TMT_LASTCOLOR   TMT_MENUBAR
    ...
    TM_PROP(2421, TMT, MINDPI2,         INT)      // min DPI ImageFile2 was designed for
    TM_PROP(2422, TMT, MINDPI3,         INT)      // min DPI ImageFile3 was designed for
    TM_PROP(2423, TMT, MINDPI4,         INT)      // min DPI ImageFile4 was designed for
    TM_PROP(2424, TMT, MINDPI5,         INT)      // min DPI ImageFile5 was designed for    
    TM_PROP(2433, TMT, MINDPI6,         INT)      // min DPI ImageFile6 was designed for
    TM_PROP(2434, TMT, MINDPI7,         INT)      // min DPI ImageFile7 was designed for
    ...
    TM_PROP(3009, TMT, IMAGEFILE6,        FILENAME)   // multiresolution image file
    TM_PROP(3010, TMT, IMAGEFILE7,        FILENAME)   // multiresolution image file
//
...
//
    ...
    TM_PROP(3410, TMT, MINSIZE6,          POSITION)   // min dest rect than ImageFile6 was designed for
    TM_PROP(3411, TMT, MINSIZE7,          POSITION)   // min dest rect than ImageFile7 was designed for
