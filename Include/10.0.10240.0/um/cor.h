...
DECLARE_INTERFACE_(IMetaDataImport2, IMetaDataImport)
{
    ...
    STDMETHOD(GetVersionString)(            // S_OK or error.
      _Out_writes_to_opt_(cchBufSize, *pccBufSize)
...
DECLARE_INTERFACE_(INativeImageInstallInfo, IUnknown)
{
    ...
    STDMETHOD (GetConfigString) (
        _Out_writes_to_opt_ (*pdwLength, *pdwLength) LPWSTR szConfigString, // [OUT]
        _Inout_ DWORD * pdwLength                   // [IN|OUT] - Number of WCHARs written including terminating NULL
        ) PURE;
