...
#define IOCTL_WMI_REALTIME_CONNECT \
          CTL_CODE(FILE_DEVICE_UNKNOWN, WmiRealtimeConnect, METHOD_BUFFERED, FILE_READ_ACCESS)
...
// query all data multiple and query single instance multiple calls.
//

#define QUERYMULTIPLEHANDLELIMIT 0x1000
...
// The following internal structre has moved to ntwmi.w. This move was due to
// the dependency on a structure introduced in evntrace.h.
// typedef struct
// {
...
//
// Data Block structure for WmiSendDataBlock
//

#define WMI_DATA_BLOCK_TYPE_ETW_ENABLE        0x00000001  // Enable notification for ETW
#define WMI_DATA_BLOCK_TYPE_ETW_PRIVATE_REQ   0x00000002  // Private logger notification for ETW
#define WMI_DATA_BLOCK_TYPE_ETW_PRIVATE_REPLY 0x00000004  // Private logger notification for ETW
#define WMI_DATA_BLOCK_TYPE_WPP_ENABLE        0x00000008  // Enable notification for Software Tracing
#define WMI_DATA_BLOCK_TYPE_PERFLIB           0x00000010  // PERFLIB V2 counter data request/delivery block
#define WMI_DATA_BLOCK_TYPE_DLL_UPDATE        0x00000040  // Dll update notification
#define WMI_DATA_BLOCK_TYPE_DLL_UPDATE_REPLY  0x00000080  // Dll update reply
#define WMI_DATA_BLOCK_TYPE_AUDIO_NOTIFY      0x00000100  // Private notification for audio policy
#define WMI_DATA_BLOCK_TYPE_RM_NOTIFY           0x00000200 // RM lightweight notification
#define WMI_DATA_BLOCK_TYPE_NO_REPLY          0x00100000  // No data block reply

#define MAX_DATA_BLOCK_BUFFER_SIZE 65536

#define IOCTL_WMI_SEND_DATA_BLOCK CTL_CODE(FILE_DEVICE_UNKNOWN, WmiSendDB, METHOD_BUFFERED, FILE_READ_ACCESS)

#define IOCTL_WMI_REPLY_DATA_BLOCK CTL_CODE(FILE_DEVICE_UNKNOWN, WmiReplyDB, METHOD_BUFFERED, FILE_READ_ACCESS)
...
//
// The DirectoryLength and NameLength defines are hard-coded so they can work
// with SAL.
//

//#define WmiGuidObjectDirectoryLength ((sizeof(WmiGuidObjectDirectory) / sizeof(WCHAR)) - 1)
//#define WmiGuidObjectNameLength (WmiGuidObjectDirectoryLength + 36)

#define WmiGuidObjectDirectoryLength (9)
