...
#define COMPACT_TRACE_MARKER32     (TRACE_HEADER_FLAG | TRACE_HEADER_EVENT_TRACE \
                                    | (TRACE_HEADER_TYPE_COMPACT32 << 16))

#define COMPACT_TRACE_MARKER64     (TRACE_HEADER_FLAG | TRACE_HEADER_EVENT_TRACE \
                                    | (TRACE_HEADER_TYPE_COMPACT64 << 16))

#define PERFINFO_TRACE_MARKER32   (TRACE_HEADER_FLAG | TRACE_HEADER_EVENT_TRACE \
                                    | (TRACE_HEADER_TYPE_PERFINFO32 << 16))

#define PERFINFO_TRACE_MARKER64   (TRACE_HEADER_FLAG | TRACE_HEADER_EVENT_TRACE \
                                    | (TRACE_HEADER_TYPE_PERFINFO64 << 16))
...
#define TRACE_HEADER_EXT_ITEMS_MASK     (TRACE_HEADER_PEBS_INDEX_FLAG | \
                                         TRACE_HEADER_PMC_COUNTERS_MASK)
...
//
// N.B. ETW_REF_CLOCK needs to be available for WOW64,
//      thus the trick with defines for ETW_WOW64.
//
...
typedef struct _WMI_BUFFER_HEADER {
    ...
    union {
        struct {                                           // DBG_INFO buffers send to debugger
...
typedef ETW_SET_KTIMER2_EVENT
    ETW_KTIMER2_EXPIRATION_EVENT, *PETW_KTIMER2_EXPIRATION_EVENT;
...
typedef ETW_TP_EVENT_CALLBACK_ENQUEUE
    ETW_TP_EVENT_CALLBACK_DEQUEUE, *PETW_TP_EVENT_CALLBACK_DEQUEUE;
...
typedef ETW_TP_EVENT_CALLBACK_START
    ETW_TP_EVENT_CALLBACK_STOP, *PETW_TP_EVENT_CALLBACK_STOP;
...
typedef ETW_WNF_EVENT_SUBSCRIBE
    ETW_WNF_EVENT_UNSUBSCRIBE, *PETW_WNF_EVENT_UNSUBSCRIBE;
...
#define PERFINFO_CLEAR_GROUP_IN_GROUPMASK(Group, pGroupMask) \
    (pGroupMask)->Masks[PERF_GET_MASK_INDEX(Group)] &= (~PERF_GET_MASK_GROUP(Group));
...
#define ETW_USER_EVENT_WITH_STACKWALK(X)     (ETW_NT_FLAGS_TRACE_SYSTEM_V2|\
                                              ETW_SKIP_USER_FRAMES(X))
