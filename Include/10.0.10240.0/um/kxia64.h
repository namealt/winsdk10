...
// Return Value:
//
//       rOldIrql - current IRQL
//
//--

#define SWAP_IRQL(rNewIrql, rOldIrql)                                          \
...
#define beginSection(SectName)                                                 \
        .section   .CRT$##SectName, "a", "progbits"

#define endSection(SectName)

#define PublicFunction(Name)                                                   \
        .global Name                                                          ;\
        .type Name,@function
