...
EXTERN_C const IID IID_IRdMsDb;
    ...
    public:
        ...
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE IsRdcmsDatabaseReachable( void) = 0;
        ...
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE ResolveDesktopAssignment( 
            /* [in] */ __RPC__in_opt IRdDesktopAssignment *pAssignment,
            /* [in] */ BOOL bAutoAssign) = 0;
    ...
    typedef struct IRdMsDbVtbl
    {
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE *ResolveDesktopAssignment )( 
            __RPC__in IRdMsDb * This,
            /* [in] */ __RPC__in_opt IRdDesktopAssignment *pAssignment,
            /* [in] */ BOOL bAutoAssign);
...
#define IRdMsDb_SaveDeploymentSetting(This,propertyName,pVarValue)	\
    ( (This)->lpVtbl -> SaveDeploymentSetting(This,propertyName,pVarValue) ) 
...
#define IRdMsDb_IsRdcmsDatabaseReachable(This)	\
    ( (This)->lpVtbl -> IsRdcmsDatabaseReachable(This) ) 
...
#define IRdMsDb_ResolveDesktopAssignment(This,pAssignment,bAutoAssign)	\
    ( (This)->lpVtbl -> ResolveDesktopAssignment(This,pAssignment,bAutoAssign) ) 
