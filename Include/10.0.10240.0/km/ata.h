...
//
// "General Statistics page" structure definition.
//

#define GP_LOG_DEVICE_STATISTIC_FLAGS \
    ULONGLONG ReservedFlags : 5; \
...
typedef struct _GP_LOG_GENERAL_STATISTICS {
    ...
    struct {                                //byte 0..7
        ULONGLONG RevisionNumber : 16;          // Shall be set to 0001h
        ULONGLONG PageNumber : 8;               // Shall be set to 01h.
        ULONGLONG Reserved : 40;
    } Header;
...
typedef struct _GP_LOG_TEMPERATURE_STATISTICS {
    ...
    struct {                                //byte 0..7
        ULONGLONG RevisionNumber : 16;          // Shall be set to 0001h
        ULONGLONG PageNumber : 8;               // Shall be set to 05h.
        ULONGLONG Reserved : 40;
    } Header;
