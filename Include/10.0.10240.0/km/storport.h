...
#define STOR_ADAPTER_FEATURE_RESERVED2                      0x00000010  // Reserved
...
typedef struct _STOR_REQUEST_INFO {
    USHORT Version;
    USHORT Size;
    ...
    BOOLEAN IsWriteRequest;
    UCHAR Reserved[3];
} STOR_REQUEST_INFO, *PSTOR_REQUEST_INFO;
...
#define STOR_POFX_COMPONENT_SIZE (FIELD_OFFSET(STOR_POFX_COMPONENT, FStates))
...
#define STOR_POFX_COMPONENT_V2_SIZE (FIELD_OFFSET(STOR_POFX_COMPONENT_V2, FStates))
...
#define STOR_POFX_DEVICE_SIZE (FIELD_OFFSET(STOR_POFX_DEVICE, Components))
...
#define STOR_POFX_DEVICE_V2_SIZE (FIELD_OFFSET(STOR_POFX_DEVICE_V2, Components))
...
#define STOR_POFX_DEVICE_V3_SIZE (FIELD_OFFSET(STOR_POFX_DEVICE_V3, Components))
