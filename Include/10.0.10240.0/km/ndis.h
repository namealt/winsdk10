...
//
     ...
     ((NDIS_MINIPORT_MINIMUM_MINOR_VERSION == 50 && NTDDI_VERSION < NTDDI_WINBLUE)  || /*TODO: Update when newer version is defined*/ \
...
//
     ...
     ((NDIS_PROTOCOL_MINIMUM_MINOR_VERSION == 50 && NTDDI_VERSION < NTDDI_WINBLUE)  || /*TODO: Update when newer version is defined*/ \
...
#define NDIS_STATUS_DOT11_FT_ASSOCIATION_COMPLETION                     ((NDIS_STATUS)0x4003002AL)
...
//
#define NDIS_GFT_OFFLOAD_INFO_INGRESS_EXCEPTION_PACKET      0x00000001
#define NDIS_GFT_OFFLOAD_INFO_EGRESS_EXCEPTION_PACKET       0x00000002
...
// returns from NdisPDFreeQueue or NdisPDOffRssReceiveQueues for that PD queue.
//
_When_(Isr==FALSE, _IRQL_requires_(DISPATCH_LEVEL))
_When_(Isr!=FALSE, _IRQL_requires_(HIGH_LEVEL))
EXPORT
VOID
