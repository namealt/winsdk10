...
// EXT
__n64  neon_ext(__n64, __n64, const int);
__n128 neon_extq(__n128, __n128, const int);
#define vext_s8(src1, src2, pos)  neon_ext(src1, src2, pos) 
#define vext_u8(src1, src2, pos)  neon_ext(src1, src2, pos) 
#define vext_s16(src1, src2, pos)  neon_ext(src1, src2, pos) 
#define vext_u16(src1, src2, pos)  neon_ext(src1, src2, pos) 
#define vext_s32(src1, src2, pos)  neon_ext(src1, src2, pos) 
#define vext_u32(src1, src2, pos)  neon_ext(src1, src2, pos) 
#define vext_s64(src1, src2, pos)  neon_ext(src1, src2, pos) 
#define vext_u64(src1, src2, pos)  neon_ext(src1, src2, pos) 
#define vext_p8(src1, src2, pos)  neon_ext(src1, src2, pos) 
#define vext_p16(src1, src2, pos)  neon_ext(src1, src2, pos) 
#define vext_p64(src1, src2, pos)  neon_ext(src1, src2, pos) 
#define vext_f32(src1, src2, pos)  neon_ext(src1, src2, pos) 
#define vext_f64(src1, src2, pos)  neon_ext(src1, src2, pos) 
#define vextq_s8(src1, src2, pos)  neon_extq(src1, src2, pos) 
#define vextq_u8(src1, src2, pos)  neon_extq(src1, src2, pos) 
#define vextq_s16(src1, src2, pos)  neon_extq(src1, src2, pos) 
#define vextq_u16(src1, src2, pos)  neon_extq(src1, src2, pos) 
#define vextq_s32(src1, src2, pos)  neon_extq(src1, src2, pos) 
#define vextq_u32(src1, src2, pos)  neon_extq(src1, src2, pos) 
#define vextq_s64(src1, src2, pos)  neon_extq(src1, src2, pos) 
#define vextq_u64(src1, src2, pos)  neon_extq(src1, src2, pos) 
#define vextq_p8(src1, src2, pos)  neon_extq(src1, src2, pos) 
#define vextq_p16(src1, src2, pos)  neon_extq(src1, src2, pos) 
#define vextq_p64(src1, src2, pos)  neon_extq(src1, src2, pos) 
#define vextq_f32(src1, src2, pos)  neon_extq(src1, src2, pos) 
#define vextq_f64(src1, src2, pos)  neon_extq(src1, src2, pos) 
