...
// TODO: bug OS:2877156 enable new error NERR_CannotUnjoinCloudDomain when localization is open
//#define NERR_CannotUnjoinCloudDomain       (NERR_BASE + 627)   /* Unable to leave the cloud domain that this machine is joined to. Check the event log for detailed error information. */
