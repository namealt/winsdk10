...
FLOAT* WINAPI D3DXFloat16To32Array
    ( _Out_writes_(n) FLOAT *pOut, _In_reads_(n) CONST D3DXFLOAT16 *pIn, UINT n );
...
FLOAT* WINAPI D3DXSHRotate
    ( _Out_writes_(Order*Order) FLOAT *pOut, UINT Order, CONST D3DXMATRIX *pMatrix, CONST FLOAT *pIn );
...
FLOAT* WINAPI D3DXSHAdd
    ( _Out_writes_(Order*Order) FLOAT *pOut, UINT Order, CONST FLOAT *pA, CONST FLOAT *pB );
...
FLOAT* WINAPI D3DXSHScale
    ( _Out_writes_(Order*Order) FLOAT *pOut, UINT Order, CONST FLOAT *pIn, CONST FLOAT Scale );
...
_Out_writes_(4)  FLOAT* WINAPI D3DXSHMultiply2(_Out_writes_(4)  FLOAT *pOut,_In_reads_(4)  CONST FLOAT *pF,_In_reads_(4)  CONST FLOAT *pG);
_Out_writes_(9)  FLOAT* WINAPI D3DXSHMultiply3(_Out_writes_(9)  FLOAT *pOut,_In_reads_(9)  CONST FLOAT *pF,_In_reads_(9)  CONST FLOAT *pG);
_Out_writes_(16) FLOAT* WINAPI D3DXSHMultiply4(_Out_writes_(16) FLOAT *pOut,_In_reads_(16) CONST FLOAT *pF,_In_reads_(16) CONST FLOAT *pG);
_Out_writes_(25) FLOAT* WINAPI D3DXSHMultiply5(_Out_writes_(25) FLOAT *pOut,_In_reads_(25) CONST FLOAT *pF,_In_reads_(25) CONST FLOAT *pG);
_Out_writes_(36) FLOAT* WINAPI D3DXSHMultiply6(_Out_writes_(36) FLOAT *pOut,_In_reads_(36) CONST FLOAT *pF,_In_reads_(36) CONST FLOAT *pG);
...
HRESULT WINAPI D3DXSHEvalDirectionalLight
    ( UINT Order, CONST D3DXVECTOR3 *pDir, 
      ...
      _Out_writes_opt_(Order*Order) FLOAT *pROut, 
      _Out_writes_opt_(Order*Order) FLOAT *pGOut, 
      _Out_writes_opt_(Order*Order) FLOAT *pBOut );
