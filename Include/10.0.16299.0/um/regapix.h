...
VMMRegQueryMultipleValues(
    _In_ HKEY hKey,
    _Out_writes_(num_vals) PVALENT val_list,
    _In_ DWORD num_vals,
    _Out_writes_bytes_(*lpdwTotalSize) LPSTR lpValueBuffer,
    _Inout_ LPDWORD lpdwTotalSize
    );
...
VMMRegEnumKey(
    HKEY hKey,
    DWORD Index,
    _Out_writes_bytes_(cbKeyName) LPSTR lpKeyName,
    DWORD cbKeyName
    );
...
VMMRegEnumValue(
    HKEY hKey,
    DWORD Index,
    _Out_writes_bytes_to_opt_(*lpcbValueName, *lpcbValueName + 1) LPSTR lpValueName,
    _Inout_ LPDWORD lpcbValueName,
    LPDWORD lpReserved,
    LPDWORD lpType,
...
VMMRegQueryInfoKey(
    HKEY hKey,
    _Out_writes_(_Inexpressible_(0)) LPSTR lpClass,
    LPDWORD lpcbClass,
    LPDWORD lpReserved,
    LPDWORD lpcSubKeys,
