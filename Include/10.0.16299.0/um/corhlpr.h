...
do { hr = (EXPR); if(FAILED(hr)) { goto LABEL; } } while (0,0)
#endif
...
#ifndef IfFailRet
#define IfFailRet(EXPR) do { hr = (EXPR); if(FAILED(hr)) { return (hr); } } while (0,0)
#endif

#ifndef IfNullRet
#define IfNullRet(EXPR) do { if ((EXPR) == NULL){ return (E_OUTOFMEMORY); } } while (0,0)
#endif
