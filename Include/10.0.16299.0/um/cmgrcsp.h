...
#ifndef __IConfigServiceProviderOutprocSupport_FWD_DEFINED__
#define __IConfigServiceProviderOutprocSupport_FWD_DEFINED__
typedef interface IConfigServiceProviderOutprocSupport IConfigServiceProviderOutprocSupport;

#endif 	/* __IConfigServiceProviderOutprocSupport_FWD_DEFINED__ */


#ifndef __IConfigServiceProviderInstanceConfiguration_FWD_DEFINED__
#define __IConfigServiceProviderInstanceConfiguration_FWD_DEFINED__
typedef interface IConfigServiceProviderInstanceConfiguration IConfigServiceProviderInstanceConfiguration;

#endif 	/* __IConfigServiceProviderInstanceConfiguration_FWD_DEFINED__ */
...
#ifndef __IConfigServiceProviderOutprocSupport_INTERFACE_DEFINED__
#define __IConfigServiceProviderOutprocSupport_INTERFACE_DEFINED__

/* interface IConfigServiceProviderOutprocSupport */
/* [object][uuid] */ 


EXTERN_C const IID IID_IConfigServiceProviderOutprocSupport;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("FABB63B3-1CF1-4C6F-A772-8D5488FA775D")
    IConfigServiceProviderOutprocSupport : public IUnknown
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE ConfigManagerGenericNotification( 
            /* [in] */ CFGMGR_NOTIFICATION cmnfyState) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE ConfigManagerLoadNotification( 
            /* [in] */ __RPC__in CSP_NOTIFICATION_LOAD_DATA *pData) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE ConfigManagerSetSessionObjNotification( 
            /* [in] */ __RPC__in_opt IConfigSession2 *pSession) = 0;
    ...
    typedef struct IConfigServiceProviderOutprocSupportVtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE *QueryInterface )( 
            __RPC__in IConfigServiceProviderOutprocSupport * This,
            /* [in] */ __RPC__in REFIID riid,
            /* [annotation][iid_is][out] */ 
            _COM_Outptr_  void **ppvObject);
        ...
        HRESULT ( STDMETHODCALLTYPE *ConfigManagerGenericNotification )( 
            __RPC__in IConfigServiceProviderOutprocSupport * This,
            /* [in] */ CFGMGR_NOTIFICATION cmnfyState);
        
        HRESULT ( STDMETHODCALLTYPE *ConfigManagerLoadNotification )( 
            __RPC__in IConfigServiceProviderOutprocSupport * This,
            /* [in] */ __RPC__in CSP_NOTIFICATION_LOAD_DATA *pData);
        
        HRESULT ( STDMETHODCALLTYPE *ConfigManagerSetSessionObjNotification )( 
            __RPC__in IConfigServiceProviderOutprocSupport * This,
            /* [in] */ __RPC__in_opt IConfigSession2 *pSession);
        
        END_INTERFACE
    } IConfigServiceProviderOutprocSupportVtbl;

    interface IConfigServiceProviderOutprocSupport
    {
        CONST_VTBL struct IConfigServiceProviderOutprocSupportVtbl *lpVtbl;
    };
...
#define IConfigServiceProviderOutprocSupport_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IConfigServiceProviderOutprocSupport_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IConfigServiceProviderOutprocSupport_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IConfigServiceProviderOutprocSupport_ConfigManagerGenericNotification(This,cmnfyState)	\
    ( (This)->lpVtbl -> ConfigManagerGenericNotification(This,cmnfyState) ) 

#define IConfigServiceProviderOutprocSupport_ConfigManagerLoadNotification(This,pData)	\
    ( (This)->lpVtbl -> ConfigManagerLoadNotification(This,pData) ) 

#define IConfigServiceProviderOutprocSupport_ConfigManagerSetSessionObjNotification(This,pSession)	\
    ( (This)->lpVtbl -> ConfigManagerSetSessionObjNotification(This,pSession) ) 
...
#endif 	/* __IConfigServiceProviderOutprocSupport_INTERFACE_DEFINED__ */


#ifndef __IConfigServiceProviderInstanceConfiguration_INTERFACE_DEFINED__
#define __IConfigServiceProviderInstanceConfiguration_INTERFACE_DEFINED__

/* interface IConfigServiceProviderInstanceConfiguration */
/* [object][uuid] */ 


EXTERN_C const IID IID_IConfigServiceProviderInstanceConfiguration;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("4367642F-E9BF-4B2A-B654-4D8A37F07C40")
    IConfigServiceProviderInstanceConfiguration : public IUnknown
    {
    public:
    ...
    typedef struct IConfigServiceProviderInstanceConfigurationVtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE *QueryInterface )( 
            __RPC__in IConfigServiceProviderInstanceConfiguration * This,
            /* [in] */ __RPC__in REFIID riid,
            /* [annotation][iid_is][out] */ 
            _COM_Outptr_  void **ppvObject);
        ...
        END_INTERFACE
    } IConfigServiceProviderInstanceConfigurationVtbl;

    interface IConfigServiceProviderInstanceConfiguration
    {
        CONST_VTBL struct IConfigServiceProviderInstanceConfigurationVtbl *lpVtbl;
    };
...
#define IConfigServiceProviderInstanceConfiguration_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IConfigServiceProviderInstanceConfiguration_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IConfigServiceProviderInstanceConfiguration_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IConfigServiceProviderInstanceConfiguration_Initialize(This,clsid,riid)	\
    ( (This)->lpVtbl -> Initialize(This,clsid,riid) ) 
...
#endif 	/* __IConfigServiceProviderInstanceConfiguration_INTERFACE_DEFINED__ */
