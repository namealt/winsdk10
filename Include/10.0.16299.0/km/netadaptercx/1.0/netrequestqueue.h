...
#ifndef _NETREQUESTQUEUE_H_
#define _NETREQUESTQUEUE_H_
...
typedef struct _NET_REQUEST_QUEUE_SET_DATA_HANDLER *PNET_REQUEST_QUEUE_SET_DATA_HANDLER;
...
typedef struct _NET_REQUEST_QUEUE_QUERY_DATA_HANDLER *PNET_REQUEST_QUEUE_QUERY_DATA_HANDLER;
...
typedef struct _NET_REQUEST_QUEUE_METHOD_HANDLER *PNET_REQUEST_QUEUE_METHOD_HANDLER;
...
typedef union _NET_REQUEST_QUEUE_ADD_HANDLER_ERROR {
    struct {
        ...
        //
        UCHAR AdapterNull : 1;
        #pragma warning(suppress:4201) // Suppress Nameless Struct Warning
    };
    UCHAR AsUchar;
...
--*/
{
    PNET_REQUEST_QUEUE_SET_DATA_HANDLER handler;
    NTSTATUS status;
...
--*/
{
    PNET_REQUEST_QUEUE_QUERY_DATA_HANDLER handler;
    NTSTATUS status;
    WDF_OBJECT_ATTRIBUTES attribs; 
    WDFMEMORY memory;
...
--*/
{
    PNET_REQUEST_QUEUE_METHOD_HANDLER handler;
    NTSTATUS status;
    WDF_OBJECT_ATTRIBUTES attribs; 
    WDFMEMORY memory;
...
{
    return ((PFN_NETREQUESTQUEUECREATE) NetFunctions[NetRequestQueueCreateTableIndex])(NetDriverGlobals, NetRequestQueueConfig, QueueAttributes, Queue);
}
...
{
    return ((PFN_NETREQUESTQUEUEGETADAPTER) NetFunctions[NetRequestQueueGetAdapterTableIndex])(NetDriverGlobals, NetRequestQueue);
}
