...
typedef enum FWPS_FIELDS_ALE_PRECLASSIFY_IP_LOCAL_ADDRESS_V4_
{
   FWPS_FIELD_ALE_PRECLASSIFY_IP_LOCAL_ADDRESS_V4_IP_LOCAL_ADDRESS,
   FWPS_FIELD_ALE_PRECLASSIFY_IP_LOCAL_ADDRESS_V4_MAX
} FWPS_FIELDS_ALE_PRECLASSIFY_IP_LOCAL_ADDRESS_V4;

typedef enum FWPS_FIELDS_ALE_PRECLASSIFY_IP_REMOTE_ADDRESS_V4_
{
   FWPS_FIELD_ALE_PRECLASSIFY_IP_REMOTE_ADDRESS_V4_IP_REMOTE_ADDRESS,
   FWPS_FIELD_ALE_PRECLASSIFY_IP_REMOTE_ADDRESS_V4_MAX
} FWPS_FIELDS_ALE_PRECLASSIFY_IP_REMOTE_ADDRESS_V4;

typedef enum FWPS_FIELDS_ALE_PRECLASSIFY_IP_LOCAL_PORT_V4_
{
   FWPS_FIELD_ALE_PRECLASSIFY_IP_LOCAL_PORT_V4_IP_LOCAL_PORT,
   FWPS_FIELD_ALE_PRECLASSIFY_IP_LOCAL_PORT_V4_MAX
} FWPS_FIELDS_ALE_PRECLASSIFY_IP_LOCAL_PORT_V4;

typedef enum FWPS_FIELDS_ALE_PRECLASSIFY_IP_REMOTE_PORT_V4_
{
   FWPS_FIELD_ALE_PRECLASSIFY_IP_REMOTE_PORT_V4_IP_REMOTE_PORT,
   FWPS_FIELD_ALE_PRECLASSIFY_IP_REMOTE_PORT_V4_MAX
} FWPS_FIELDS_ALE_PRECLASSIFY_IP_REMOTE_PORT_V4;

typedef enum FWPS_FIELDS_ALE_PRECLASSIFY_IP_LOCAL_ADDRESS_V6_
{
   FWPS_FIELD_ALE_PRECLASSIFY_IP_LOCAL_ADDRESS_V6_IP_LOCAL_ADDRESS,
   FWPS_FIELD_ALE_PRECLASSIFY_IP_LOCAL_ADDRESS_V6_MAX
} FWPS_FIELDS_ALE_PRECLASSIFY_IP_LOCAL_ADDRESS_V6;

typedef enum FWPS_FIELDS_ALE_PRECLASSIFY_IP_REMOTE_ADDRESS_V6_
{
   FWPS_FIELD_ALE_PRECLASSIFY_IP_REMOTE_ADDRESS_V6_IP_REMOTE_ADDRESS,
   FWPS_FIELD_ALE_PRECLASSIFY_IP_REMOTE_ADDRESS_V6_MAX
} FWPS_FIELDS_ALE_PRECLASSIFY_IP_REMOTE_ADDRESS_V6;

typedef enum FWPS_FIELDS_ALE_PRECLASSIFY_IP_LOCAL_PORT_V6_
{
   FWPS_FIELD_ALE_PRECLASSIFY_IP_LOCAL_PORT_V6_IP_LOCAL_PORT,
   FWPS_FIELD_ALE_PRECLASSIFY_IP_LOCAL_PORT_V6_MAX
} FWPS_FIELDS_ALE_PRECLASSIFY_IP_LOCAL_PORT_V6;

typedef enum FWPS_FIELDS_ALE_PRECLASSIFY_IP_REMOTE_PORT_V6_
{
   FWPS_FIELD_ALE_PRECLASSIFY_IP_REMOTE_PORT_V6_IP_REMOTE_PORT,
   FWPS_FIELD_ALE_PRECLASSIFY_IP_REMOTE_PORT_V6_MAX
} FWPS_FIELDS_ALE_PRECLASSIFY_IP_REMOTE_PORT_V6;
